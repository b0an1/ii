...
TpTab:Paragraph({ Title = "传送", Desc = "传送点" })

local tps = {
    ["警察枪械"] = Vector3.new(856.14, 102.62, 2256.75),
    ["小偷基地"] = Vector3.new(-981.62, 108.12, 2056.98),
    ["监狱外面"] = Vector3.new(485.23, 97.99, 2244.82),
    ["召唤小偷车"] = Vector3.new(-915.86, 95.13, 2134.13),
    ["召唤警车"] = Vector3.new(615.49, 98.20, 2488.75),
}
...
CombatTab:Input({
    ...
    Callback = function(Text)
        if Text and Text ~= "" then
            ...
            WindUI:Notify({Title = "黑名单", Desc = "已豁免玩家: " .. Text, Type = "success"})
        end
    end
})
...
local function CreateESP(player)
    ...
    local function Setup(character)
        ...
        RunService.RenderStepped:Connect(function()
            ...
            local teamName = player.Team and player.Team.Name or "未知"
